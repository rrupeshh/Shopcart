<?php
	...
	if($submit == "Submit"){
		if(empty($_POST['txtProdName']))
			...
			$sql = "INSERT INTO `product_home`(`prod_name`, `prod_image`, `prod_price`, `prod_quan`, `date_added`, `keyword`) VALUES ('$prod_name', '$prod_image', '$prod_price', '$prod_quan', now(), '$keyword')";
    ...
    <body>
		...
		<div id="admin_content">
			<h2>Product Information <span style="color: #a11; font-size: 13px; margin-left: 50px;"><?php echo $msg; ?><span></h2>
                ...
                <div id = "form">
			<form id="addnew_product_form" method="post" action="add_home.php" enctype="multipart/form-data">
			<table>
			<!--
				<tr>
					<td>Product No:</td>
